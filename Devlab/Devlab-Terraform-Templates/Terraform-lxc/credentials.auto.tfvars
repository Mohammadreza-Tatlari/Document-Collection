...
proxmox_api_url = "https://172.24.3.9:8006/api2/json"

#API token ID in the format: user@auth!token_name
#Example: root@pam!mytoken
proxmox_api_token_id = "root@pam!terraform-provision"

# API token secret generated from proxmox
proxmox_api_token = "01946f83-68f0-4663-8558-b158c3189252"